...
<html>
  ...
  <div class="container">
    ...
    <button class="btn btn-success" onclick="add_receita()"><i class="glyphicon glyphicon-plus"></i> Add Receita</button>
    <br />
    <br />
    <table id="table_id" class="table table-striped table-bordered" cellspacing="0" width="100%">
      ...
      <tbody>
                ...
                <td><?php echo $receita->rec_status;?></td>
								<td>
									<button class="btn btn-success" onclick="edit_receita(<?php echo $receita->rec_id;?>)"><i class="glyphicon glyphicon-usd"></i></button>
									<button class="btn btn-danger" onclick="delete_receita(<?php echo $receita->rec_id;?>)"><i class="glyphicon glyphicon-remove"></i></button>
								</td>
				      </tr>
				     <?php }?>
      </tbody>
